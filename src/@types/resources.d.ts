interface Resources {
  commons: {
    actions: {
      ...
      "global-traits": {
        title: "Global Traits:";
        hint: "Click here to edit global traits";
      };
    };
    "chat-page": {
      actions: {
    ...
    "upload-area": {
      ...
      "camera-tip": {
        ...
        tips: [
          "Prefer natural light and avoid glare.",
          "Fill the frame with the problem. Keep text sharp.",
          "One question per shot yields better recognition.",
        ];
